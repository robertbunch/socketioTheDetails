...
let namespaces = [];
let wikiNs = new Namespace(1,'Wiki','https://upload.wikimedia.org/wikipedia/en/thumb/8/80/Wikipedia-logo-v2.svg/103px-Wikipedia-logo-v2.svg.png','/wiki');
let mozNs = new Namespace(2,'Mozilla','https://www.mozilla.org/media/img/logos/firefox/logo-quantum.9c5e96634f92.png','/mozilla');
let linuxNs = new Namespace(3,'Linux','https://upload.wikimedia.org/wikipedia/commons/a/af/Tux.png','/linux');
